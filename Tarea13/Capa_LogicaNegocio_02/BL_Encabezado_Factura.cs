...
{
    internal class BL_Encabezado_Factura
    {
        ...
        public BL_Encabezado_Factura(int id_Factura, DateTime fecha, int id_Cliente, decimal sub_Total, decimal impuesto, decimal montoDescuento)
        {
